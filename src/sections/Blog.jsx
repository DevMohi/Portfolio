      ...
      <section className="">
        ...
        <div className="bg-gradient-to-r from-indigo to-storm border border-gray-50/[.1] rounded-xl shadow-lg hover:bg-royal hover-animation transition-all duration-300">
          <div className="flex justify-between items-start p-6">
            <h3 className="font-bold text-xl text-white">{blogPost.title}</h3>
            <p className="text-sm text-neutral-300">{blogPost.date}</p>
          </div>

          <div className="px-6 pb-6">
            <p className="mt-2 text-neutral-200">{blogPost.description}</p>
            <div className="mt-4 flex flex-wrap justify-between items-center gap-2">
              ...
              <button className="px-4 py-2 border border-white/20 bg-white/10 text-white rounded-md hover:bg-royal hover:shadow-lg transition-all duration-300">
                View
              </button>
            </div>
          </div>
